...
16. [Streaming & Messaging. Cloud Based Integration 🌟](message-queue.md) 
17. [Caching Solutions](caching.md)
...
22. Development & Frameworks
    ...
    - [Xamarin](xamarin.md)
23. [Serverless Architectures & Frameworks. OpenFaaS, Knative & Kubeless](serverless.md)
24. Dev Environment    
...
27. [E-Learning](elearning.md)
28. [Customer Success Stories 🌟](customer.md)
29. [Subreddits and Newsfeeds](newsfeeds.md)
30. [Other Awesome Lists 🌟](other-awesome-lists.md)
