...
24. [Meshery](#meshery)
25. [Monokle](#monokle)
26. [K8studio](#k8studio)
27. [KubeLibrary](#kubelibrary)
28. [kube-vip](#kube-vip)
29. [Kubermetrics](#kubermetrics)
30. [Kustomizer](#kustomizer)
31. [MetalLB](#metallb)
32. [Kubermatic Kubernetes Platform](#kubermatic-kubernetes-platform)
    1. [Kubermatic Kubeone](#kubermatic-kubeone)
33. [Usernetes](#usernetes)
34. [k8syaml.com](#k8syamlcom)
35. [Popeye](#popeye)
36. [kbrew](#kbrew)
37. [KubExplorer](#kubexplorer)
38. [Kubescape](#kubescape)
39. [Kubectl Connections](#kubectl-connections)
40. [Benchmark Operator](#benchmark-operator)
41. [Source-To-Image (S2I)](#source-to-image-s2i)
42. [VMware Tanzu Octant](#vmware-tanzu-octant)
43. [Qovery Engine](#qovery-engine)
44. [mck8s Container orchestrator for multi-cluster Kubernetes](#mck8s-container-orchestrator-for-multi-cluster-kubernetes)
45. [Shipwright framework](#shipwright-framework)
46. [Schiff (Deutsche Telekom)](#schiff-deutsche-telekom)
47. [NetMaker](#netmaker)
48. [AWS Karpenter kubernetes Autoscaler](#aws-karpenter-kubernetes-autoscaler)
49. [Kuby (easy deployments of Ruby Rails App)](#kuby-easy-deployments-of-ruby-rails-app)
50. [Direktiv](#direktiv)
51. [Jabos](#jabos)
52. [Pleco](#pleco)
53. [Mesh-kridik](#mesh-kridik)
54. [kubewatch](#kubewatch)
55. [Botkube](#botkube)
56. [Robusta](#robusta)
57. [Soup GitOps Operator](#soup-gitops-operator)
58. [Epinio](#epinio)
59. [Testkube](#testkube)
60. [KuberLogic](#kuberlogic)
61. [Kusk](#kusk)
62. [Azure AD Workload Identity](#azure-ad-workload-identity)
63. [Kubernate](#kubernate)
64. [Tackle](#tackle)
65. [Azure Placement Policy Scheduler Plugins](#azure-placement-policy-scheduler-plugins)
66. [Azure AAD Pod Identity](#azure-aad-pod-identity)
67. [Azure](#azure)
68. [MicroShift](#microshift)
69. [kubefwd (Kube Forward)](#kubefwd-kube-forward)
70. [Kpng. Kubernetes Proxy NG](#kpng-kubernetes-proxy-ng)
71. [Auto-portforward (apf)](#auto-portforward-apf)
72. [Gardener](#gardener)
73. [Werf](#werf)
74. [Starboard kubernetes-native security toolkit](#starboard-kubernetes-native-security-toolkit)
75. [Netshoot](#netshoot)
76. [The Hierarchical Namespace Controller (HNC)](#the-hierarchical-namespace-controller-hnc)
77. [Kratix](#kratix)
78. [gRPC-Gateway](#grpc-gateway)
79. [KubeOrbit. Test your app on kubernetes](#kubeorbit-test-your-app-on-kubernetes)
80. [Mizu API Traffic Viewer for Kubernetes](#mizu-api-traffic-viewer-for-kubernetes)
81. [vcluster](#vcluster)
82. [Kateyes](#kateyes)
83. [Keepass Secret](#keepass-secret)
84. [Workflow Schedulers](#workflow-schedulers)
    1. [Komodor Workflows](#komodor-workflows)
85. [Azure Eraser](#azure-eraser)
86. [Data Pipeline Workflow Schedulers](#data-pipeline-workflow-schedulers)
87. [ConfigMap Reloader](#configmap-reloader)
88. [Kluctl](#kluctl)
89. [k2tf Kubernetes YAML to Terraform HCL converter](#k2tf-kubernetes-yaml-to-terraform-hcl-converter)
90. [Kubernetes Security Tools](#kubernetes-security-tools)
91. [PureLB](#purelb)
92. [Murre](#murre)
93. [k9s](#k9s)
94. [Pluto](#pluto)
95. [Konf Lightweight Kubeconfig Manager](#konf-lightweight-kubeconfig-manager)
96. [K8spacket](#k8spacket)
97. [Infrastructure as Code using Kubernetes. Config Connector](#infrastructure-as-code-using-kubernetes-config-connector)
98. [Claudie Cloud-agnostic managed Kubernetes](#claudie-cloud-agnostic-managed-kubernetes)
99. [Observability Monitoring Tools](#observability-monitoring-tools)
    1. [Debugging and Troubleshooting Tools](#debugging-and-troubleshooting-tools)
100. [Security](#security)
101. [Develop microservices locally while being connected to your Kubernetes environment](#develop-microservices-locally-while-being-connected-to-your-kubernetes-environment)
102. [AI Tools](#ai-tools)
103. [Tweets](#tweets)
104. [Videos](#videos)
105. [kubernetes-tools](#kubernetes-tools)
...
## K8s Tools
  - [Floci - An AWS Local Emulator Alternative](https://github.com/floci-io/floci) 🌟 - Floci is a free and open-source local AWS emulator that aims to provide an alternative to AWS LocalStack. It leverages Docker Compose for easy setup and operation, allowing developers to test AWS services locally without requiring an AWS account or dealing with feature gates.
  - [Tabularis: Open-Source Desktop Client for Modern Databases with AI Features](https://github.com/TabularisDB/tabularis/blob/main/README.es.md) - Tabularis is an open-source desktop client designed for modern databases, offering support for PostgreSQL, MySQL/MariaDB, and SQLite. It features SQL notebooks, AI functions, MCP integration, and an external plugin system. This entry specifically links to the Spanish README file.
  ...
  - [Kubeterm: Graphical Kubernetes Management Tool](https://github.com/kbterm/kubeterm) 🌟 - Kubeterm is a desktop and mobile graphical management tool for Kubernetes clusters. It offers clear visibility into clusters, simplifies resource and application management, and aids in troubleshooting without requiring any installation within the cluster. It supports multiple platforms and integrates with cloud provider accounts (GCP, Azure, AWS) for seamless cluster access.
...
## Penetration Testing Tools
  - [Web Check](https://web-check.xyz/) - A tool to verify that your website is accessible, fast, and secure.
