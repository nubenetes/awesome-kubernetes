...
- [itnext.io: Jenkins: running workers in Kubernetes and Docker images build](https://itnext.io/jenkins-running-workers-in-kubernetes-and-docker-images-build-83299a10f3ca?gi=828dca656811)
...
- [itnext.io: Jenkins Tutorial — Part 1 — Pipelines 🌟](https://itnext.io/jenkins-tutorial-part-1-pipelines-bd1397cf5509?gi=ab5da40717fe)
    - [itnext.io: Jenkins Tutorial — Part 2 — Pipeline Variables 🌟](https://itnext.io/jenkins-tutorial-part-2-pipeline-variables-5e4783aa2c07?gi=5aed3895feb0)
    - [itnext.io: Jenkins Tutorial — Part 3 — Parameterized Pipeline 🌟](https://itnext.io/jenkins-tutorial-part-3-parameterized-pipeline-3898643ac6ad?gi=2fc3a04e4e48)
    - [itnext.io: Jenkins Tutorial — Part 7 — Interactive Pipelines 🌟](https://itnext.io/jenkins-tutorial-part-7-interactive-pipelines-a739b23ac41c?gi=87b8d5fdfc69)
...
- [==inder-devops.medium.com: CI/CD setup in just 5 mins with basic yaml configuration==](https://towardsdev.com/ci-cd-setup-in-just-5-mins-with-basic-yaml-configuration-95b8e894a110?gi=a4bb7b8a596c)
...
- [==faun.pub: Set up Jenkins on a Kubernetes Cluster==](https://faun.pub/set-up-jenkins-on-a-kubernetes-cluster-2b982c840ebe?gi=982473ee118a)
- [blog.devops.dev: Blue-Green Deployment (CI/CD) Pipelines with Docker, GitHub, Jenkins and SonarQube](https://blog.devops.dev/blue-green-deployment-ci-cd-pipelines-with-docker-github-and-jenkins-6a262b2994c6?gi=acc9f49f3fe8)
- [itnext.io: Accelerate Development with Jenkins Pipelines and Continuous Integration](https://itnext.io/accelerate-development-with-jenkins-pipelines-and-continuous-integration-9a6c7857ccd2?gi=afd3716c016d)
...
- [blog.devops.dev: Deploying Helm Charts with Jenkins and Groovy: A Comprehensive Guide](https://blog.devops.dev/deploying-helm-charts-with-jenkins-and-groovy-a-comprehensive-guide-c2aa0f2bd424?gi=e82400bff03e)
...
- [aws.plainenglish.io: Deploying AWS Resources and a Jenkins Server with Terraform](https://aws.plainenglish.io/deploying-aws-resources-and-a-jenkins-server-with-terraform-297bad905459?gi=876bbcd1481b)
- [aws.plainenglish.io: Terraform: How To Deploy Jenkins CI/CD Pipelines Using Terraform](https://aws.plainenglish.io/terraform-how-to-deploy-jenkins-ci-cd-pipelines-using-terraform-9ffc086dcd56?gi=8b9b41ebb3af) Deploy an EC2 instance bootstrapped with a script to install and run Jenkins.
...
- [ssbostan/jenkins-stack-kubernetes 🌟](https://github.com/ssbostan/jenkins-stack-kubernetes) Scripts and manifests to deploy Jenkins on Kubernetes
    ...
    - [itnext.io: Jenkins Tutorial — Part 7 — Interactive Pipelines](https://itnext.io/jenkins-tutorial-part-7-interactive-pipelines-a739b23ac41c?gi=f7c01805fb51)
...
- [cuelogic.com: Decoding Pipeline as Code (With Jenkins) 🌟](https://cuelogic.medium.com/decoding-pipeline-as-code-with-jenkins) Pipeline as code technique rests on the paradigm that delivery pipeline configuration which builds, tests, deploys applications, and software infrastructure must be treated as code.
...
- [faun.pub: Automate Jenkins Pipelines management with Jenkins Job Builder 🌟](https://faun.pub/automate-jenkins-pipelines-management-6e771b5890f?gi=fd91f303a529) - [demo code](https://github.com/mysticrenji/jenkins-cicd-pipelines)
...
- [itnext.io: Ansible and Jenkins — automate your scritps 🌟](https://itnext.io/ansible-and-jenkins-automate-your-scritps-8dff99ef653?gi=1f2f112e7bec)
...
- [**Cloudbees Flow** 🌟](https://www.cloudbees.com/capabilities/ci-cd-workflows)
...
- [itnext.io: docker in docker](https://itnext.io/docker-in-docker-521958d34efd?gi=1d9af6bd2c5d)
...
- [itnext.io: Jenkins X — Managing Jenkins](https://itnext.io/jenkins-x-managing-jenkins-926f0e0f8bcf?gi=ba5d703c240e)
- Video Tutorials:
