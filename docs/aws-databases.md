...
- [itnext.io: Manage Redis on AWS from Kubernetes](https://itnext.io/manage-redis-on-aws-from-kubernetes-eeadba7eb889?gi=c5aa04a53462)
...
## AWS Data Mesh and Batch Data Processing
  - **(2026)** [Data Projects: Managing Data Assets at Netflix Scale](https://netflixtechblog.com/data-projects-managing-data-assets-at-netflix-scale-7ca25888591e?gi=85bd9366f0f4&source=rss----2615bd06b42e---4) 🌟 - An introduction to Data Projects, an abstraction designed to manage access governance, identity, and assets collectively at scale.
