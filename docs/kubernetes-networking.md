...
- [ibm.com: Multizone Kubernetes and VPC Load Balancer Setup](https://www.ibm.com/blog/multizone-kubernetes-and-vpc-load-balancer-setup/) Securely expose your Kubernetes app by setting up a Load Balancer for VPC in a different zone.
...
- [buoyant.io: Kubernetes network policies with Cilium and Linkerd](https://buoyant.io/blog/kubernetes-network-policies-with-cilium-and-linkerd)
