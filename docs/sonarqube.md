...
- [SonarQube Scanner Overview](https://docs.sonarsource.com/sonarqube-server/analyzing-source-code/overview/)
    ...
    - [Azure DevOps - SonarQube Extension for Azure DevOps](https://docs.sonarsource.com/sonarqube-server/analyzing-source-code/scanners/sonarscanner-for-azure-devops/)
