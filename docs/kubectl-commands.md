...
- [ibm.com: 8 Kubernetes Tips and Tricks 🌟](https://www.ibm.com/blog/8-kubernetes-tips-and-tricks) Most of the tips given below are using kubectl, a powerful command-line tool that allows you to execute commands against Kubernetes clusters.
...
- [Kubernetes productivity tips and tricks 🌟](https://www.padok.fr/blog/kubernetes-productivity-tips)
