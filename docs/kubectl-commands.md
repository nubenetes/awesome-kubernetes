...
- [itnext.io: Boosting your kubectl productivity](https://itnext.io/boosting-your-kubectl-productivity-b348f7c25712?gi=5bdee59c7bea)
...
- [blog.devgenius.io: K8s — Manage Multiple Clusters Using kubectl at Scale](https://blog.devgenius.io/k8s-manage-multiple-clusters-using-kubectl-at-scale-9f200c692099?gi=fc385dc57d7d) Manage multiple K8s clusters efficiently using kubectl
- [==itnext.io: How to Restart Kubernetes Pods With Kubectl== 🌟](https://itnext.io/how-to-restart-kubernetes-pods-with-kubectl-2a7834a6b961?gi=7cda3765f82c) A pod is the smallest unit in Kubernetes (K8S). They should run until they are replaced by a new deployment. Because of this, there is no way to restart a pod, instead, it should be replaced.
- [awstip.com: Kubernetes — Creating deployments via command line and with YAML files](https://awstip.com/kubernetes-creating-deployments-via-command-line-and-with-yaml-files-783eaad7b3be?gi=d97f4d270c71)
...
- [itnext.io: Kubernetes Contexts: Complete Guide for Developers](https://itnext.io/kubernetes-contexts-complete-guide-for-developers-7ea5b2fc75c7?gi=54f325244201) An introduction to Kubeconfig and Contexts. It’s finally time to understand how kubectl connects to Kubernetes.
...
- [blog.devgenius.io: Daily useful Kubernetes aliases](https://blog.devgenius.io/daily-useful-kubernetes-aliases-c35f7f411f39?gi=e3ab1a26852f)

## Kubectl explain

- [kubectl explain](https://jamesdefabia.github.io/docs/user-guide/kubectl/kubectl_explain)
- [==itnext.io: Using ‘kubectl explain’ for Custom Resources==](https://itnext.io/understanding-kubectl-explain-9d703396cc8?gi=0c61adc2134c) Goal: Explore if ‘kubectl explain’ can be used to discover static information about Custom Resources
...
- [itnext.io: Connect to containers using Kubectl Exec](https://itnext.io/connect-to-containers-using-kubectl-exec-b1fb5c171f03?gi=ddbfc39273ad) the kubectl exec command to show how to get a shell into a running container in your Kubernetes (K8S) cluster, and how to run individual commands on a container with some useful examples.
