...
- [slideshare.net: Git version control and trunk based approach with VSTS](https://www.slideshare.net/slideshow/git-version-control-and-trunk-based-approach-with-vsts/111085503)
