...
<center>
<iframe src="//www.slideshare.net/slideshow/embed_code/key/qc1rIHqvXuiuzj" width="595" height="485" scrolling="no" style="max-width: 100%;" allowfullscreen> </iframe> <div style="margin-bottom:0px"> <strong> <a href="//www.slideshare.net/KangarootLinux/openshift-4-the-smarter-kubernetes-platform" title="OpenShift 4, the smarter Kubernetes platform" target="_blank">OpenShift 4, the smarter Kubernetes platform</a> </strong> de <strong><a href="https://www.slideshare.net/KangarootLinux" target="_blank">Kangaroot</a></strong> </div>
