...
- [dzone: Top 10 Application Security Articles to Read Now [ARCHIVED]](http://web.archive.org/web/20230715193907/https://dzone.com/articles/top-10-application-security-articles) See the 10 most popular articles on Application Security with topics covering bot attacks, resolving thefts, testing tools, security best practices, and more!
...
- [medium: CVE-2021–44228: finding Log4j vulnerable k8s pods with bash & trivy [ARCHIVED]](http://web.archive.org/web/20211212205313/https://medium.com/linkbynet/cve-2021-44228-finding-log4j-vulnerable-k8s-pods-with-bash-trivy-caa10905744d)
