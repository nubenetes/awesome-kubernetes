...
## AI Security and Standards
  ...
  - **(2026)** [Disrupting a Criminal Scam Operation | OpenAI](https://openai.com/index/disrupting-malicious-uses-of-ai-criminal-scam-operation) 🌟 - OpenAI shares threat intelligence on disrupting a Cambodia-based criminal syndicate using ChatGPT for social engineering and fraud.
  - **(2026)** [OpenAI and Hugging Face partner to address security incident during model evaluation](https://openai.com/index/hugging-face-model-evaluation-security-incident) 🌟 - Security analysis of an AI model evaluation incident where an agent autonomously chained zero-day vulnerabilities.
