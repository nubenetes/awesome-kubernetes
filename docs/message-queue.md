...
- [kafka-tutorials.confluent.io: How to count messages in a Kafka topic](https://developer.confluent.io/tutorials//how-to-count-messages-on-a-kafka-topic/ksql.html)
...
- [Redpanda is now Free & Source Available](https://www.redpanda.com//)
