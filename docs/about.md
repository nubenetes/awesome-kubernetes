...
A service driven IT sector (with ambiguities and many hidden interests) the product is the hours billed by the consultant, being irrelevant the content of the job and the delivered quality. It is thus difficult not to find technical solutions under the policy of applying "the most difficult, non-standard, slow and obfuscated way possible" (doing weird things) as a competitive element. This does not scale. Being ambiguous in JDs (not to say dishonest) without clarifying the real content of the job is easy and very well paid. 
