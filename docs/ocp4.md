...
- [openshift.com: Red Hat OpenShift 4.7 Is Now Available](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/red-hat-openshift-4.7-is-now-available)
    - Kubernetes 1.20
...
- [openshift.com: How to Offer Service Running on OpenShift on AWS to Other AWS VPCs, Privately 🌟](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/how-to-offer-service-running-on-openshift-on-aws-to-other-aws-vpcs-privately)
...
- [Red Hat OpenShift Platform Plus 🌟](https://www.redhat.com/en/technologies/cloud-computing/openshift/products/platform-plus) Build, deploy, run, manage, and secure intelligent applications at scale across the hybrid cloud.
...
- [openshift.com: Using VPC Peering to Connect an OpenShift Service on an AWS (ROSA) Cluster to an Amazon RDS MySQL Database in a Different VPC](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/using-vpc-peering-to-connect-an-openshift-service-on-an-aws-rosa-cluster-to-an-amazon-rds-mysql-database-in-a-different-vpc)
...
- [OpenShift End-to-End: **Day 2** - Cluster Customization 🌟](https://www.redhat.com/en/blog/openshift-end-to-end-cluster-customization)
    - [Ask an OpenShift Admin Office Hour - Day 2 Operations, Part 1](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/ask-an-openshift-admin-office-hour-day-2-operations-part-1)
    - [Ask an OpenShift Admin Office Hour - Day 2 Operations, Part 2](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/ask-an-openshift-admin-office-hour-day-2-operations-part-2)
...
- [Router plug-ins in OCP3:](https://docs.openshift.com/container-platform/3.11/install_config/router/index.html)
    ...
    - Since the 9th May 2018, [NGINX](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/introducing-nginx-and-nginx-plus-routers-for-openshift) is also available as « router ».
- Routers in OCP4:
...
- [Openshift 4 image builds](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/openshift-4-image-builds)
...
[![ocp4 cni arch](images/ocp4_cni_arch.png)](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/demystifying-multus)
...
- [openshift.com: Demystifying Multus 🌟](https://www.redhat.com/en/technologies/cloud-computing/openshift/blog/demystifying-multus)
...
- [Red Hat OpenShift Container Storage 4](https://www.redhat.com/en/technologies/cloud-computing/openshift/products/container-storage/)
