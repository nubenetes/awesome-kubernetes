...
- [itnext.io: AWS CDK for EKS — Handling Helm Charts](https://itnext.io/aws-cdk-for-eks-handling-helm-charts-aa002afedde4?gi=d9d34887191c)
...
- [faun.pub: Using AWS Session Manager For Port Forwarding To Remote Hosts](https://faun.pub/using-aws-session-manager-for-port-forwarding-to-remote-hosts-8168589ba579?gi=e464b3e4dc98)
...
- [Trainline.com dumps Oracle and Microsoft, gulps AWS Kool-Aid](https://www.theregister.com/2016/07/13/trainline_dumps_oracle_microsoft_goes_full_aws_cto_interview)
