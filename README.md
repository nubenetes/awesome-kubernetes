...
Every Pull Request generated by the Agentic engine includes a non-blocking **Safety and Mandate Audit** report. This report cross-references the changes against the foundations defined in [`GEMINI.md`](GEMINI.md):
